            ...
            <div className="request-layout">
              <div className="card liquid-card glow">
                <div className="card-pad">
                  ...
                  <h3 className="card-title">Kontaktweg wählen</h3>
              ...
              <div className={`card liquid-card subtle form-card ${requestMode === "form" ? "form-card-show" : "form-card-muted"}`}>
                <div className="card-pad">
                  <div className="request-form-head">
                    ...
                    <h3 className="card-title">Projektanfrage</h3>
                    <p className="body-text">Für strukturierte Anfragen mit Unterlagen oder Fotos.</p>
                  </div>
                  ...
                  {formState === "success" ? (
                    <div className="soft-box liquid-card subtle" style={{ textAlign: "center", padding: "32px 20px", marginTop: "16px" }}>
                      ...
                      <p className="body-text">Rückmeldung in der Regel innerhalb von 24 Stunden.</p>
                    </div>
                  ) : (
                    <form onSubmit={handleFormSubmit} className="form-stack">
                      ...
                      <div><label className="field-label">Projektart / Thema</label><input className="input glass-input" placeholder="z. B. Sanierung, Erweiterung" value={formData.projectType} onChange={e => setFormData(p => ({ ...p, projectType: e.target.value }))} /></div>
                      <div>
                      ...
                      <div><label className="field-label">Beschreibung</label><textarea className="input textarea glass-input" placeholder="Kurze Projektbeschreibung" value={formData.description} onChange={e => setFormData(p => ({ ...p, description: e.target.value }))} /></div>
                      {formState === "error" && (
