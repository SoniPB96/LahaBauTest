export const calculatorAdmin = {
  ...
  roomEquipment: [
    { key: "rooms", label: "Raumanzahl ohne Küche und Badezimmer", unitPrice: 220, min: 1, max: 100, note: "Kein echter Einzelartikel, sondern ein Strukturwert für typische Grundausstattung je Raum." },
    { key: "steckdosen", label: "Steckdosen", unitPrice: 98, min: 0, max: 250, note: "Interner Kalkulationswert pro zusätzlicher Steckdose im Orientierungspreis." },
    { key: "schalter", label: "Lichtschalter", unitPrice: 82, min: 0, max: 150, note: "Interner Kalkulationswert pro Lichtschalter." },
    { key: "netzwerkdosen", label: "Netzwerkdosen", unitPrice: 149, min: 0, max: 60, requiresOption: "lan", note: "Nur relevant, wenn LAN / Netzwerk verlegen aktiv ist." },
    { key: "lampenauslaesse", label: "Lampenauslässe", unitPrice: 92, min: 0, max: 150, note: "Typischer Richtwert pro Lichtauslass." },
    { key: "rollladenschalter", label: "Rollladenschalter", unitPrice: 136, min: 0, max: 60, note: "Eigener Wert wegen zusätzlichem Material- und Leitungsaufwand." },
    { key: "raumthermostate", label: "Raumthermostate für Fußbodenheizung", unitPrice: 210, min: 0, max: 60, requiresOption: "fussbodenheizung", note: "Nur relevant bei aktivierter Fußbodenheizung." },
  ],
  ...
  priceLogic: {
    ...
    laborShare: 0.56,
    materialShare: 0.31,
    brandImpactShare: 0.31,
    brandAffectsMaterialOnly: true,
    notes: {
      ...
      brandImpactShare: "Nur dieser Anteil des Zwischenwerts wird durch die Markenwahl beeinflusst. So verteuert eine Premium-Marke nicht künstlich die komplette Arbeitsleistung.",
      brandAffectsMaterialOnly: "Wenn true, wirkt die Materiallinie nur auf den materialrelevanten Anteil und nicht auf den gesamten Projektwert.",
    },
  },
};
