export const siteConfig = {
  ...
  hero: {
    ...
    text: "Ich unterstütze Privatkunden bei Sanierung, Modernisierung und Erweiterung elektrischer Anlagen – mit sauberer Ausführung, klarer Abstimmung und realistischer Ersteinschätzung.",
    trustLine: "Elektroarbeiten im Raum Paderborn und Umgebung. Planung und Ausführung in Zusammenarbeit mit Meisterbetrieb.",
    estimatorCardInfo: "Unverbindliche Preisspanne auf Basis von Projektart, Ausstattung, Zusatzoptionen und Material.",
  },
  services: {
    eyebrow: "Leistungen",
  ...
  begleitung: {
    ...
    text: "Für umfangreichere Sanierungsprojekte kann ich die technische Begleitung und Koordination gemeinsam mit lokalen Partnerbetrieben übernehmen. Die Ausführung erfolgt abgestimmt, strukturiert und mit klarem Ansprechpartner.",
    subline: "Ein Ansprechpartner, klare Koordination und ein sauberes Ergebnis – statt Chaos durch mehrere unkoordinierte Gewerke.",
    intro: "Je nach Projektumfang kann die Baubegleitung von einer einfachen, zweckmäßigen Sanierung bis hin zur hochwertigen oder luxuriösen Ausführung organisiert werden.",
    points: [
    ...
    cards: [
      { title: "Zweckmäßige Sanierung", text: "Für Projekte mit klarem Kostenfokus und sauberer, funktionaler Umsetzung ohne unnötige Extras." },
      { title: "Gehobene Modernisierung", text: "Für Eigentümer, die Wert auf bessere Materialien, sauberere Details und eine koordinierte Umsetzung legen." },
      { title: "Hochwertige / Luxus-Sanierung", text: "Für anspruchsvolle Projekte mit höherem Qualitätsanspruch, feiner Materialauswahl und enger Abstimmung aller Beteiligten." },
    ],
  },
  requestPage: {
    eyebrow: "Anfrage",
    title: "Anfrage stellen",
    text: "Hier läuft alles zusammen: direkte Kontaktwege, strukturierte Erstangaben und die Möglichkeit, Unterlagen oder Grundrisse bereitzustellen.",
    quickTitle: "Direkte Kontaktwege",
    quickText: "Für schnelle Abstimmung eignet sich WhatsApp meist am besten. Für strukturierte Anfragen kannst du alternativ anrufen, E-Mail nutzen oder das Formular auswählen.",
    ...
    formNote: "Frontend-Stand: Das Formular ist aktuell visuell vorbereitet, aber noch nicht an einen Versand angebunden.",
  },
  estimator: {
    ...
    disclaimer: "Dies ist nur eine unverbindliche erste Kostenschätzung und ersetzt kein verbindliches Angebot vor Ort.",
    ...
    requestNote: "Frontend-Stand: Das Formular ist bewusst nur visuell vorbereitet und noch nicht an einen Versand angebunden.",
    ...
    roomInfoText: "Bitte gib hier zuerst an, wie viele Räume das Objekt ohne Küche und Badezimmer hat. Erst danach folgt die Ausstattung für diese übrigen Räume.",
    componentFields: [
    ...
    materialInfo: "Hier wählst du das gewünschte Schalterprogramm. Die Auswahl beeinflusst vor allem das Materialniveau und den späteren Preisbereich.",
    brandChoices: [
    ...
    defaults: {
      ...
      brand: "gira",
      options: {
        uv: false, zaehlerschrank: false, lan: false, aussenbereich: false,
        kueche: false, bad: false, waermepumpe: false, wallbox: false,
      },
      fileName: "", name: "", phone: "", email: "", zip: "", message: "",
    },
    priceConfig: {
      projectBase: { neubau_neuinstallation: 2600, sanierung_altbau: 1600 },
      sqm: { neubau_neuinstallation: 75, sanierung_altbau: 46 },
      components: { rooms: 220, steckdosen: 98, schalter: 82, netzwerkdosen: 149, lampenauslaesse: 92, rollladenschalter: 136 },
      options: { uv: 1450, zaehlerschrank: 3200, lan: 820, aussenbereich: 990, kueche: 2600, bad: 2200, waermepumpe: 920, wallbox: 1180 },
      brandFactor: { gira: 1.12, merten: 1.08, schneider: 1.1, jung: 1.13, buschjaeger: 1.09 },
      objectFactor: { wohnung: 1, einfamilienhaus: 1.05, mehrfamilienhaus: 1.03, gewerbe: 1.12 },
      range: 0.14, laborShare: 0.56, materialShare: 0.31, extraShare: 0.13,
    },
  },
};
